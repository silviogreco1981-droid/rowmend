...
assert.ok(homepage.includes('id="homepageTutorialPageLink"'), 'Homepage demo CTA must be trackable');
assert.ok(homepage.includes('tutorial_page_clicked'), 'Homepage must track tutorial page clicks');
